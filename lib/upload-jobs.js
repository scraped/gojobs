...
function generateStats(job) {
  ...
  // I. If the name starts with shit (or non-english letters), decrease rating
  // significantly
  if (name[0].match(/[^\w]/)) {
    ratingPoints *= 0.1;
  }

  // II. The more CAPITALIZED LETTERS are in the name, the less rating is
  ...
  // III. If it is not a race, decrease rating
