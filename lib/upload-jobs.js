...
function getCategory(type, mode) {
  ...
  // Not all types has correspoing modes, in this cases index
  // won't be found and modeId will be 1 + (-1) = 0
  modeId = 1 + _.findIndex(modes[typeId].modes, m => m.name === mode);
