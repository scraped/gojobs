 ...
 * @param {boolean} forcedUpload re-upload ALL the jobs.
 * WARNING: it can take a lot of time!
 * @returns {object} object {amount<number>, errors<number>}
 */
exports.uploadRawJobs = async function({ limit = 5000, forcedUpload = false }) {
 ...
 * @returns {undefined}
 */
async function uploadRawJob({ rawJob, forcedUpload }) {
