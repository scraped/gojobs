...
function generateStats(rgscJob) {
  ...
  const name = rgscJob.Metadata.name,
    playTot = rgscJob.stats.pt,
    playUnq = rgscJob.stats.pu,
    quitUnq = rgscJob.stats.qu,
    quitTot = rgscJob.stats.qt,
    likes = rgscJob.ratings.rt_pos,
    dislikesQuit = rgscJob.ratings.rt_neg,
